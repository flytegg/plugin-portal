...
import gg.flyte.pluginportal.common.util.appendLine
...
object PortalLogger {
    ...
    private val dataFolder = PluginPortalBase.plugin.dataFolder
    ...
    fun warn(message: String) {
        PluginPortalBase.plugin.logger.warning(message)
    }
    
    fun error(message: String) {
        PluginPortalBase.plugin.logger.severe(message)
    }
    ...
    fun log(record: Record) {
        PluginPortalBase.plugin.logger.log(Level.INFO, record.timelessDescription)
        writeToFile(record)
    }
    ...
    enum class Action {
        ...
        LOAD_PLUGINS, SAVE_PLUGINS, WEBSOCKET;
    }
}
