...
import gg.flyte.common.type.software.*
...
enum class SoftwareType(
    ...
    FOLIA(ServerType.PLUGINS, PlatformType.FOLIA, "Modified Version of Paper, This will break nearly every plugin.", FoliaSoftware),
    ...
    TRAVERTINE(ServerType.PROXY, PlatformType.TRAVERTINE, "Modified version of Waterfall which supports 1.7.", TravertineSoftware),
