...
enum class SoftwareType(
    ...
    BUKKIT(ServerType.BUKKIT, PlatformType.SPIGOT, "Old and outdated, not used.."),
    SPIGOT(ServerType.BUKKIT, PlatformType.SPIGOT, "Old and outdated, but still used."),
    PAPER(ServerType.BUKKIT, PlatformType.PAPER, "The most common, stable, and recommended.", true),
    PURPUR(ServerType.BUKKIT, PlatformType.PAPER, "Modified Version of Paper, with more features though less stable."),
    FOLIA(ServerType.BUKKIT, PlatformType.FOLIA, "Modified Version of Paper, This will break nearly every plugin.", true),
    ...
    WATERFALL(ServerType.PROXY, PlatformType.WATERFALL,"Modified version of Bungeecord.", true),
    VELOCITY(ServerType.PROXY, PlatformType.VELOCITY, "PaperMC's remake of Bungeecord.", true),
    TRAVERTINE(ServerType.PROXY, PlatformType.TRAVERTINE, "Modified version of Waterfall which supports 1.7.", true),
